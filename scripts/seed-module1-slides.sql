...
values (
  ...
  $j$[
    {"type": "hero", "title": {"en": "ICMS 3.0", "es": "ICMS 3.0"}, "subtitle": {"en": "Online Course", "es": "Curso en Línea"}},
...
values (
  ...
  $j$[
    ...
    {"type": "list", "ordered": true, "items": [
      ...
      {"en": "Module 4 — ICMS3.0 suite of applications: an overview of the tools that make up ICMS3.0.", "es": "Módulo 4 — Suite de Aplicaciones ICMS3.0: una visión general de las herramientas que componen ICMS3.0."},
